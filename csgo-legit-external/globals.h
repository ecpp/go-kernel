...
namespace offset
{
    ...
    inline std::ptrdiff_t dwLocalPlayerPawn = 24277736;
    inline std::ptrdiff_t dwLocalPlayerController = 26220872;
    inline std::ptrdiff_t dwEntityList = 25894888;
    inline std::ptrdiff_t dwViewMatrix = 26284752;
